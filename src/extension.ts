...
export function activate(context: vscode.ExtensionContext) {
	if (typeof navigator === 'object') {	// do not run under node.js
		...
		vscode.commands.executeCommand('vscode.open', vscode.Uri.parse('memfs:/' + MemFS.project_name + '/' + MemFS.start_file));
	}
}
...
function updateDiagnostics(document: vscode.TextDocument, collection: vscode.DiagnosticCollection): void {
	if (document && document.fileName === MemFS.project_name + '/' + MemFS.start_file) {
